...
//        startActivity(new Intent(getContext(), MainActivity.class).putExtra("showAlert", true));
        ...
        edt_service_mobile = findViewById(R.id.edt_service_mobile);
        verifyemail = findViewById(R.id.verify_email);
        btn_continue = findViewById(R.id.btn_serv_detail_sign_up);
        txt_doc1 = findViewById(R.id.txt_doc1);
        txt_doc2 = findViewById(R.id.txt_doc2);
        txt_upload1 = findViewById(R.id.txt_upload1);
        txt_upload2 = findViewById(R.id.txt_upload2);
