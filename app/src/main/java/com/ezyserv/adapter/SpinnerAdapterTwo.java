...
public class SpinnerAdapterTwo extends BaseAdapter {
    Context context;
    int SpinnerIcons[];
    String[] SpinnerText;
    LayoutInflater inflter;

    public SpinnerAdapterTwo(Context applicationContext, int[] SpinnerIcons, String[] SpinnerText) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.avialibity_spinner_item, null);
