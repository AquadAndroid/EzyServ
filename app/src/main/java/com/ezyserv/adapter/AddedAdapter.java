...
public class AddedAdapter extends RecyclerView.Adapter<AddedAdapter.DataHolder> {
    private List<DummyAddedItem> listdata;
    private LayoutInflater inflater;
    private AddedAdapter.ItemClickCallback itemclickcallback;
    private int count = 0;
    ...
    public void SetItemClickCallback(final AddedAdapter.ItemClickCallback itemClickCallback) {
        this.itemclickcallback = itemClickCallback;
    }

    public AddedAdapter(List<DummyAddedItem> listdata, Context c) {
    ...
    @Override
    public AddedAdapter.DataHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = inflater.inflate(R.layout.addded_money_item, parent, false);
        return new AddedAdapter.DataHolder(view);

    }


    @Override
    public void onBindViewHolder(AddedAdapter.DataHolder holder, int position) {
