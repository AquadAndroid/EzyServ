...
public class AllRequestsAdapter extends RecyclerView.Adapter<AllRequestsAdapter.DataHolder> {
    private List<DummyAddedItem> listdata;
    private LayoutInflater inflater;
    private AllRequestsAdapter.ItemClickCallback itemclickcallback;
    private int count = 0;
    ...
    public void SetItemClickCallback(final AllRequestsAdapter.ItemClickCallback itemClickCallback) {
        this.itemclickcallback = itemClickCallback;
    }

    public AllRequestsAdapter(List<DummyAddedItem> listdata, Context c) {
    ...
    @Override
    public AllRequestsAdapter.DataHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = inflater.inflate(R.layout.addded_money_item, parent, false);
        return new AllRequestsAdapter.DataHolder(view);

    }


    @Override
    public void onBindViewHolder(AllRequestsAdapter.DataHolder holder, int position) {
